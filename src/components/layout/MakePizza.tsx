...
const MakePizza = () => {
  ...
  return (
    <div className="w-full md:container mx-auto grid max-w-full  overflow-hidden relative  p-10 text-Black h-fit">
      <Title>
        <span className=" text-Cooper "> Workshop de Pão e Pizza</span> <br />
      </Title>
      <SubTitle className="pt-2 ">Uma Noite de Sabor e Aprendizado</SubTitle>
