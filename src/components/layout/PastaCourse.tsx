    ...
    <section className="w-full   container">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2">
        <div className=" md:my-auto ">
          <Title className={`pt-8 md:pb-10 text-center bottom-4 font-semibold `}>Mão na massa</Title>
          <Title className={` pt-8  text-center bottom-4 font-semibold mb-10 `}>
            Crie, <span className=" text-Cooper">Deguste</span>, Aprenda
          </Title>
        </div>
