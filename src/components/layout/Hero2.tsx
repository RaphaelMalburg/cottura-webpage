        ...
        <div className="md:container mx-auto  grid h-full w-full grid-cols-1  lg:mt-14 md:grid-cols-2">
          <div className="col-span-1">
            ...
            <div className="grid grid-cols-2  h-96 ">
              {" "}
              <div className="grid grid-rows-3  justify-center mt-10 h-fit sm:grid-rows-1 sm:grid-cols-3 z-40 md:gap-10 gap-8">
              ...
              <Image
                ...
                src="/pastanest.png"
                alt="Pasta nest"
                className="col-span-1 mt-20  h-full max-h-[30rem]  max-w-[15rem] -translate-y-32 md:max-h-[38rem]  md:max-w-[18rem] lg:-mt-40 lg:max-h-[48rem] lg:max-w-[24rem] lg:translate-y-0"
              />{" "}
            </div>{" "}
